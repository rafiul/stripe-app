            ...
            <div class="card-body">
              ...
              <div class="">
                ...
                <p class="mb-1">
                  ...
                  <?php echo sanitize_output($stripe_account['stripe_user_id']); ?>
                </p>
                <p class="mb-1">
                  <strong>Last verified:</strong>
                  <?php echo $stripe_account['last_verified_at'] ? date('M j, Y g:i a', strtotime($stripe_account['last_verified_at'])) : 'Never'; ?>
                </p>
                <p class="mb-0">
                  <strong>Key type:</strong>
                  <?php echo $stripe_account['is_live'] ? 'Live production key' : 'Test key'; ?>
                </p>
              </div>
              ...
              <div class="d-flex gap-2">
                ...
                <form
                  method="POST"
                  action="<?php echo BASE_URL; ?>/stripe-verify.php"
                  class="d-inline"
                >
                  <input
                    type="hidden"
            ...
            <div class="card-body">
              ...
              <div class="">
                <h5 class="alert-heading">
                  ...
                  <span
                    class="badge bg-<?php echo QBO_ENVIRONMENT === 'sandbox' ? 'warning text-dark' : 'primary'; ?>"
                  >
                    <?php echo QBO_ENVIRONMENT === 'sandbox' ? 'SANDBOX' : 'PRODUCTION'; ?>
                  </span>
                </h5>
                <p>
                  Your QuickBooks account is
                  <?php echo $is_token_expired ? 'expired' : 'connected'; ?>.
                </p>
                <hr />
                <p class="mb-1">
                  <strong>Realm ID:</strong>
                  <?php echo sanitize_output($qbo_account['realm_id']); ?>
                </p>
                <p class="mb-1">
                  <strong>Connected since:</strong>
                  <?php echo date('M j, Y', strtotime($qbo_account['created_at'])); ?>
                </p>
                <p class="mb-1">
                  <strong>Token expires:</strong>
                  <?php echo date('M j, Y g:i a', strtotime($qbo_account['access_token_expires_at'])); ?>
                </p>
                <p class="mb-0">
                  <strong>Status:</strong>
                  <?php echo $is_token_expired ? 'Expired' : 'Active'; ?>
                </p>
              </div>
              ...
              <div class="d-flex gap-2">
                <a
                  ...
                  class="btn btn-danger"
                  >Disconnect QuickBooks</a
                >
                <?php if ($is_token_expired): ?>
                <a
                  href="<?php echo get_qbo_auth_url(); ?>"
                  class="btn btn-primary"
                  >Reconnect</a
                >
                <?php endif; ?>
