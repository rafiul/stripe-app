        ...
        <div class="custom-col-20 d-none d-sm-block">
            <div class="card">
                <div class="card-body sidebar">
                    <a class="navbar-brand" href="<?php echo BASE_URL; ?>/dashboard.php"><img src="<?php echo BASE_URL; ?>/assets/images/Stripe_logo-W.png" alt="Stripe Logo" class="brand-logo"></a>
